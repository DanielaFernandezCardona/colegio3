...
<body>
		<div class="container">
			<div class="form__top">
				...
				<input class="input" type="text" name=  NombreEstu placeholder="&#128100; NombreEstu" required autofocus>
            	<input class="input" type="text" name=  apellido   placeholder="&#127968; apellido" required>
            	<input class="input" type="text" name=  fechaNac   placeholder="&#127968; fechaNac" required>
            	<input class="input" type="text" name=  documento  placeholder="&#127968; documento" required>
            	<input class="input" type="text" name=  fechaExp   placeholder="&#127968; FechaExpedicón" required>
            ...
            <div class="btn__form">
            	...
            	<input class="btn__reset" type="reset" value="BORRAR">	
            	<input class="btn__submit" type="button" value="EDITAR">	
            </div>
		</form>
	</div>
